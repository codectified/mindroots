  ...
  return (
    <div style={{ marginTop: '8px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
        ...
        <button
          onClick={clearAll}
          style={{ fontSize: '11px', padding: '2px 6px', cursor: 'pointer', border: '1px solid #ccc', borderRadius: '3px', background: '#f8f8f8' }}
        >
          All
        </button>
        <button
        ...
        {SURAHS.map(surah => {
          ...
          return (
            ...
            >
              ...
              />
              <span style={{ color: '#333' }}>{surah.number}. {surah.english}</span>
            </label>
          );
        })}
      </div>
